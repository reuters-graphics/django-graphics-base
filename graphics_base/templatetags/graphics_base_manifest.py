...
VITE_DEV_MODE = getattr(settings, "GRAPHICS_BASE_VITE_DEV_MODE", False)

VITE_SERVER_PROTOCOL = getattr(settings, "GRAPHICS_BASE_VITE_SERVER_PROTOCOL", "http")
VITE_SERVER_HOST = getattr(settings, "GRAPHICS_BASE_VITE_SERVER_HOST", "localhost")
VITE_SERVER_PORT = getattr(settings, "GRAPHICS_BASE_VITE_SERVER_PORT", 3000)

VITE_OUT_DIR = "vite"
APP_STATIC_DIR = "graphics_base"
